...
void remove_stopwords(std::vector<std::string>& words) {
	std::vector<std::string> stopwords = {
		"a", "of", "the", "an", "to", "on", "does", "with", "other", "their", "when", "both", "these",
		"here", "this", "that", "who", "have", "has", "such", "which", "or", "most", "over", "if", "was",
		"were", "but", "will", "would", "should", "shall", "into", "accord", "at", "away", "as", "i",
		"he", "she", "had", "before", "me", "you", "are", "until", "than", "its", "by", "very", "why",
		"and", "not", "can", "once", "been", "they"
	};
	
	for (int i = 0; i < stopwords.size(); i++) {
		words.erase(std::remove(words.begin(), words.end(), stopwords[i]), words.end());
	}
}
